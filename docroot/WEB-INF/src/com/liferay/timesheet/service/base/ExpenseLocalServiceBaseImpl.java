...
/**
 * The base implementation of the expense local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.timesheet.service.impl.ExpenseLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.timesheet.service.impl.ExpenseLocalServiceImpl
 * @see com.liferay.timesheet.service.ExpenseLocalServiceUtil
 * @generated
 */
public abstract class ExpenseLocalServiceBaseImpl implements ExpenseLocalService,
	IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.timesheet.service.ExpenseLocalServiceUtil} to access the expense local service.
	 */
	...
	public Expense addExpense(Expense expense) throws SystemException {
		...
		expense = expensePersistence.update(expense, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(expense);
			}
	...
	public void deleteExpense(long expenseId)
		...
		Expense expense = expensePersistence.remove(expenseId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(expense);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteExpense(Expense expense) throws SystemException {
	...
	public Expense updateExpense(Expense expense) throws SystemException {
		return updateExpense(expense, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Expense updateExpense(Expense expense, boolean merge)
		throws SystemException {
		expense.setNew(false);

		expense = expensePersistence.update(expense, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.timesheet.model.Expense",
			expenseLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.timesheet.model.Expense");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(ExpenseLocalServiceBaseImpl.class);
