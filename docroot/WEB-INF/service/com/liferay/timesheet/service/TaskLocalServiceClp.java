...
public class TaskLocalServiceClp implements TaskLocalService {
	public TaskLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addTaskMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addTask", com.liferay.timesheet.model.Task.class);

		_createTaskMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createTask", long.class);

		_deleteTaskMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteTask", long.class);

		_deleteTaskMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteTask", com.liferay.timesheet.model.Task.class);
		...
		_getTaskMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"getTask", long.class);

		_getPersistedModelMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPersistedModel", java.io.Serializable.class);

		_getTasksMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
				"getTasks", int.class, int.class);

		_getTasksCountMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
				"getTasksCount");

		_updateTaskMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateTask", com.liferay.timesheet.model.Task.class);

		_updateTaskMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateTask", com.liferay.timesheet.model.Task.class,
				boolean.class);
	...
	public com.liferay.timesheet.model.Task createTask(long taskId) {
		...
		MethodHandler methodHandler = new MethodHandler(_createTaskMethodKey1,
				taskId);
	...
	public void deleteTask(long taskId)
		...
		MethodHandler methodHandler = new MethodHandler(_deleteTaskMethodKey2,
				taskId);
	...
	public void deleteTask(com.liferay.timesheet.model.Task task)
		throws com.liferay.portal.kernel.exception.SystemException {
		MethodHandler methodHandler = new MethodHandler(_deleteTaskMethodKey3,
				ClpSerializer.translateInput(task));
	...
	public com.liferay.timesheet.model.Task getTask(long taskId)
		...
		MethodHandler methodHandler = new MethodHandler(_getTaskMethodKey8,
				taskId);
	...
	public java.util.List<com.liferay.timesheet.model.Task> getTasks(
		...
		MethodHandler methodHandler = new MethodHandler(_getTasksMethodKey10,
				start, end);
	...
	public int getTasksCount()
		...
		MethodHandler methodHandler = new MethodHandler(_getTasksCountMethodKey11);
	...
	public com.liferay.timesheet.model.Task updateTask(
		...
		MethodHandler methodHandler = new MethodHandler(_updateTaskMethodKey12,
				ClpSerializer.translateInput(task));
	...
	public com.liferay.timesheet.model.Task updateTask(
		...
		MethodHandler methodHandler = new MethodHandler(_updateTaskMethodKey13,
				ClpSerializer.translateInput(task), merge);
	...
	public com.liferay.timesheet.model.Task addTask(long projectId,
		...
		MethodHandler methodHandler = new MethodHandler(_addTaskMethodKey16,
	...
	private MethodKey _createTaskMethodKey1;
	private MethodKey _deleteTaskMethodKey2;
	private MethodKey _deleteTaskMethodKey3;
	private MethodKey _dynamicQueryMethodKey4;
	private MethodKey _dynamicQueryMethodKey5;
	private MethodKey _dynamicQueryMethodKey6;
	private MethodKey _dynamicQueryCountMethodKey7;
	private MethodKey _getTaskMethodKey8;
	private MethodKey _getPersistedModelMethodKey9;
	private MethodKey _getTasksMethodKey10;
	private MethodKey _getTasksCountMethodKey11;
	private MethodKey _updateTaskMethodKey12;
	private MethodKey _updateTaskMethodKey13;
