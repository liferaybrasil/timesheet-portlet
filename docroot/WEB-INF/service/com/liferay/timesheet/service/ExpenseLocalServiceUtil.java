...
/**
 * The utility for the expense local service. This utility wraps {@link com.liferay.timesheet.service.impl.ExpenseLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.liferay.timesheet.service.base.ExpenseLocalServiceBaseImpl
 * @see com.liferay.timesheet.service.impl.ExpenseLocalServiceImpl
 * @generated
 */
public class ExpenseLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.timesheet.service.impl.ExpenseLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.timesheet.model.Expense createExpense(
		long expenseId) {
	...
	*/
	public static void deleteExpense(long expenseId)
		...
		getService().deleteExpense(expenseId);
	}
	...
	*/
	public static void deleteExpense(
		com.liferay.timesheet.model.Expense expense)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteExpense(expense);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.liferay.timesheet.model.Expense> getExpenses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	public static com.liferay.timesheet.model.Expense updateExpense(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateExpense(expense, merge);
	}
	...
	*/
	...
	public static com.liferay.timesheet.model.Expense addExpense(
		long projectId, java.lang.String description, int billledDateMonth,
		int billledDateDay, int billledDateYear, int type, double value,
		java.io.File file, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addExpense(projectId, description, billledDateMonth,
			billledDateDay, billledDateYear, type, value, file, groupId);
	}
	...
	public static com.liferay.timesheet.model.Expense updateExpense(
		...
		int type, double value, java.io.File file, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateExpense(expenseId, projectId, description,
			billledDateDay, billledDateMonth, billledDateYear, type, value,
			file, groupId);
	}
	...
	public static ExpenseLocalService getService() {
		if (_service == null) {
			...
			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					ExpenseLocalService.class.getName(), portletClassLoader);

			_service = new ExpenseLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(ExpenseLocalServiceUtil.class,
				"_service");
			MethodCache.remove(ExpenseLocalService.class);
		}
