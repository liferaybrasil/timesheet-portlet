...
public class TaskServiceUtil {
	...
	public static TaskService getService() {
		if (_service == null) {
			...
			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					TaskService.class.getName(), portletClassLoader);

			_service = new TaskServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(TaskServiceUtil.class,
				"_service");
			MethodCache.remove(TaskService.class);
		}
	...
	public void setService(TaskService service) {
		...
		ReferenceRegistry.registerReference(TaskServiceUtil.class, "_service");
		MethodCache.remove(TaskService.class);
	}
