...
public class ProjectLocalServiceClp implements ProjectLocalService {
	public ProjectLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_addProjectMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addProject", com.liferay.timesheet.model.Project.class);

		_createProjectMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createProject", long.class);

		_deleteProjectMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteProject", long.class);

		_deleteProjectMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteProject", com.liferay.timesheet.model.Project.class);
		...
		_getProjectMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"getProject", long.class);

		_getPersistedModelMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPersistedModel", java.io.Serializable.class);

		_getProjectsMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
				"getProjects", int.class, int.class);

		_getProjectsCountMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
				"getProjectsCount");

		_updateProjectMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateProject", com.liferay.timesheet.model.Project.class);

		_updateProjectMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateProject", com.liferay.timesheet.model.Project.class,
				boolean.class);
		...
		_addProjectMethodKey16 = new MethodKey(_classLoaderProxy.getClassName(),
				"addProject", long.class, java.lang.String.class, double.class,
				java.lang.String.class, int.class, int.class, int.class,
				int.class, int.class, int.class);

		_updateProjectMethodKey17 = new MethodKey(_classLoaderProxy.getClassName(),
	...
	public void deleteProject(com.liferay.timesheet.model.Project project)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	public java.util.List<com.liferay.timesheet.model.Project> getProjects(
		...
		MethodHandler methodHandler = new MethodHandler(_getProjectsMethodKey10,
				start, end);
	...
	public int getProjectsCount()
		...
		MethodHandler methodHandler = new MethodHandler(_getProjectsCountMethodKey11);
	...
	public com.liferay.timesheet.model.Project updateProject(
		...
		MethodHandler methodHandler = new MethodHandler(_updateProjectMethodKey13,
				ClpSerializer.translateInput(project), merge);
	...
	public com.liferay.timesheet.model.Project addProject(long userId,
		java.lang.String name, double wage, java.lang.String description,
		...
		MethodHandler methodHandler = new MethodHandler(_addProjectMethodKey16,
				userId, ClpSerializer.translateInput(name), wage,
	...
	public com.liferay.timesheet.model.Project updateProject(long projectId,
		long userId, java.lang.String name, double wage,
		...
		MethodHandler methodHandler = new MethodHandler(_updateProjectMethodKey17,
				projectId, userId, ClpSerializer.translateInput(name), wage,
				ClpSerializer.translateInput(description), startDateMonth,
				startDateDay, startDateYear, endDateMonth, endDateDay,
				endDateYear);
	...
	private MethodKey _createProjectMethodKey1;
	private MethodKey _deleteProjectMethodKey2;
	private MethodKey _deleteProjectMethodKey3;
	private MethodKey _dynamicQueryMethodKey4;
	private MethodKey _dynamicQueryMethodKey5;
	private MethodKey _dynamicQueryMethodKey6;
	private MethodKey _dynamicQueryCountMethodKey7;
	private MethodKey _getProjectMethodKey8;
	private MethodKey _getPersistedModelMethodKey9;
	private MethodKey _getProjectsMethodKey10;
	private MethodKey _getProjectsCountMethodKey11;
	private MethodKey _updateProjectMethodKey12;
	private MethodKey _updateProjectMethodKey13;
	private MethodKey _getBeanIdentifierMethodKey14;
	private MethodKey _setBeanIdentifierMethodKey15;
	private MethodKey _addProjectMethodKey16;
	private MethodKey _updateProjectMethodKey17;
}