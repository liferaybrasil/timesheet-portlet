...
public class ExpenseLocalServiceClp implements ExpenseLocalService {
	public ExpenseLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addExpenseMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addExpense", com.liferay.timesheet.model.Expense.class);

		_createExpenseMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createExpense", long.class);

		_deleteExpenseMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteExpense", long.class);

		_deleteExpenseMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteExpense", com.liferay.timesheet.model.Expense.class);
		...
		_getExpenseMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"getExpense", long.class);

		_getPersistedModelMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPersistedModel", java.io.Serializable.class);

		_getExpensesMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
				"getExpenses", int.class, int.class);

		_getExpensesCountMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
				"getExpensesCount");

		_updateExpenseMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateExpense", com.liferay.timesheet.model.Expense.class);

		_updateExpenseMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateExpense", com.liferay.timesheet.model.Expense.class,
				boolean.class);
	...
	public com.liferay.timesheet.model.Expense addExpense(
		...
		MethodHandler methodHandler = new MethodHandler(_addExpenseMethodKey0,
				ClpSerializer.translateInput(expense));
	...
	public com.liferay.timesheet.model.Expense createExpense(long expenseId) {
		...
		MethodHandler methodHandler = new MethodHandler(_createExpenseMethodKey1,
				expenseId);
	...
	public void deleteExpense(long expenseId)
		...
		MethodHandler methodHandler = new MethodHandler(_deleteExpenseMethodKey2,
				expenseId);
	...
	public void deleteExpense(com.liferay.timesheet.model.Expense expense)
		throws com.liferay.portal.kernel.exception.SystemException {
		MethodHandler methodHandler = new MethodHandler(_deleteExpenseMethodKey3,
				ClpSerializer.translateInput(expense));
	...
	public com.liferay.timesheet.model.Expense getExpense(long expenseId)
		...
		MethodHandler methodHandler = new MethodHandler(_getExpenseMethodKey8,
				expenseId);
	...
	public java.util.List<com.liferay.timesheet.model.Expense> getExpenses(
		...
		MethodHandler methodHandler = new MethodHandler(_getExpensesMethodKey10,
				start, end);
	...
	public int getExpensesCount()
		...
		MethodHandler methodHandler = new MethodHandler(_getExpensesCountMethodKey11);
	...
	public com.liferay.timesheet.model.Expense updateExpense(
		...
		MethodHandler methodHandler = new MethodHandler(_updateExpenseMethodKey12,
				ClpSerializer.translateInput(expense));
	...
	public com.liferay.timesheet.model.Expense updateExpense(
		...
		MethodHandler methodHandler = new MethodHandler(_updateExpenseMethodKey13,
				ClpSerializer.translateInput(expense), merge);
	...
	private MethodKey _createExpenseMethodKey1;
	private MethodKey _deleteExpenseMethodKey2;
	private MethodKey _deleteExpenseMethodKey3;
	private MethodKey _dynamicQueryMethodKey4;
	private MethodKey _dynamicQueryMethodKey5;
	private MethodKey _dynamicQueryMethodKey6;
	private MethodKey _dynamicQueryCountMethodKey7;
	private MethodKey _getExpenseMethodKey8;
	private MethodKey _getPersistedModelMethodKey9;
	private MethodKey _getExpensesMethodKey10;
	private MethodKey _getExpensesCountMethodKey11;
	private MethodKey _updateExpenseMethodKey12;
	private MethodKey _updateExpenseMethodKey13;
