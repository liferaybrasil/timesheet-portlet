	...
	public static ProjectLocalService getService() {
		if (_service == null) {
			...
			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					ProjectLocalService.class.getName(), portletClassLoader);
			...
			ReferenceRegistry.registerReference(ProjectLocalServiceUtil.class,
				"_service");
			MethodCache.remove(ProjectLocalService.class);
		}
